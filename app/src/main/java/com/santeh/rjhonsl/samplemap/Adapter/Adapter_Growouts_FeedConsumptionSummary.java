...
public class Adapter_Growouts_FeedConsumptionSummary extends ArrayAdapter<CustInfoObject> {
	...
	public Adapter_Growouts_FeedConsumptionSummary(Context context, int resourceId, List<CustInfoObject> items) {
